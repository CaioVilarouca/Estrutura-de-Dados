...
int main() {
    ...
    do {
        ...
        // || se a primeira condição já for true, não avalia a segunda
    ...
    for (int i = 0; i < qtdAlunos; i++) {
        ...
        if (Turma[i].Resultado) {
            printf("Nome: %-10s | Sexo: %c | Situacao: [ Aprovado ] A media solicitada foi %0.2f \n", Turma[i].Nome, Turma[i].Sexo, mediaAprovacao);
        }
    }
    ...
    for (int i = 0; i < qtdAlunos; i++) {
        ...
        if (!Turma[i].Resultado) {
            printf("Nome: %-10s | Sexo: %c | Situacao: [ Reprovado ] A media solicitada foi %0.2f \n", Turma[i].Nome, Turma[i].Sexo, mediaAprovacao);
        }
    }
